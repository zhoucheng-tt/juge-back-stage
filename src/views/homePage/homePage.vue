    ...
    <div class="left">
      <div class="leftContent">
        ...
        <div class="leftCharts">
          ...
          <!-- 充电桩收入按月分析   -->
          <div class="leftChartCenter" id="chargeEarn">
      ...
      <div class="centerUp">
        ...
        <div class="leftUpContentNum">
          <div class="leftUpContentNumContent" v-for="(item, index) in contentNumList" key="index">
            ...
            <!--                        第二行-->
            <el-row style="margin-top: 4%;display: flex">
              <el-row  style="display:flex;width: 600px">
  ...
  export default {
    ...
    methods: {
      ...
      queryParkCount(){
        ...
        console.log('总停车数量参数',param)
        this.$homePage.queryParkCount(param).then(res => {
          that.totalCarPark=res.resultEntity;
          if (that.totalCarPark == null) {
            that.totalCarPark = 0;
          }
        })
      },
...
<style scoped>
  ...
  .leftUpContentSwitch2{
    background-color: rgba(32,52,156,1);
  }
  .leftUpContentSwitch1,
