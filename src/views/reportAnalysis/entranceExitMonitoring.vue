          ...
          <el-dialog title="详情"
            ...
            <el-row style="display: flex">
              ...
              <el-row class="rightcontent">
                ...
                <el-button type="primary"
                           @click="getOutRecord(selectedInRecord.inRecordId)">追踪出场记录
                </el-button>
              </el-row>
            </el-row>
            <el-row v-if="downshow === 1"
              ...
              <el-row style="width: 30%">
                <img :src="selectedOutRecord2.outImage"
                     class="dialog-upimg" />
              </el-row>
              <el-row class="rightcontent">
        ...
        <el-form :inline="true"
          ...
          <el-form-item label="停车场:">
            <el-select size="small"
              ...
              <el-option label="全部"
                         value="" />
              <el-option v-for="(item, index) in parkingLotList2"
                         :label="item.name"
                         :value="item.code"
                         :key="index"></el-option>
            </el-select>
          ...
          <!--    时间-->
          <el-form-item label="选择时间:">
            <el-date-picker v-model="downQueryList.minDateTime"
                            type="datetime"
                            size="small"
                            style="width: 185px"
                            value-format="yyyy-MM-dd HH:mm:ss"
            ...
            <el-date-picker v-model="downQueryList.maxDateTime"
                            type="datetime"
                            size="small"
                            style="width: 185px"
                            placeholder="请选择截止日期"
          ...
          <el-form-item>
            <el-button type="primary"
                       size="small"
                       @click="queryDownFormList">查询
            </el-button>
            <el-button size="small"
                       @click="downResetQuery">重置 </el-button>
          </el-form-item>
        </el-form>
      </el-row>
      <el-row class="data-content">
        <el-row class="upImg">
          <img :src="selectedOutRecord.outImage"
               class="upImg-content" />
        </el-row>
        <el-row class="upTable">
          <el-table :cell-style="{
            ...
            <el-table-column :show-overflow-tooltip="true"
              ...
              <template slot-scope="scope">
                <el-button size="small"
                           type="text"
                           @click="showDownDetail(scope.row)">查看详情
                </el-button>
              </template>
            </el-table-column>
          </el-table>
          ...
          <el-dialog title="详情"
            ...
            <el-row style="display: flex">
              ...
              <el-row class="rightcontent">
                ...
                <el-button type="primary"
                           @click="getInRecord(selectedOutRecord.inRecordId)">追踪入场记录
                </el-button>
              </el-row>
            </el-row>
            <el-row v-if="upshow === 1"
                    style="display: flex;margin-top: 20px">
              <el-row style="width: 30%">
                <img :src="selectedInRecord2.inImage"
                     class="dialog-upimg" />
              </el-row>
              <el-row class="rightcontent">
...
export default {
  ...
  methods: {
    ...
    queryToday () {
      ...
      this.upQueryList.minDateTime = t + " " + "00:00:00"
      this.upQueryList.maxDateTime = t + " " + "23:59:59"
      this.downQueryList.minDateTime = t + " " + "00:00:00"
      this.downQueryList.maxDateTime = t + " " + "23:59:59"
    },
    //上半部查询按钮
    queryUpFormList () {
      this.upPageNum = 1;
    ...
    resetQuery () {
      ...
      this.upQueryList = {
        parkId: "",
        plateNumber: "",
        minDateTime: t + " " + "00:00:00",
        maxDateTime: t + " " + "23:59:59",
        pageNum: 1,
