...
<template>
  <div class="about">
    ...
    >
      ...
      <!-- 按次计费弹出表格 -->
      <el-row v-if="addChargeList.billingRuleTypeCode === 0">
        <span>按次计费</span>
          ...
          <div style="width: 60%">
            ...
            <div style="display: flex">
              ...
              <div style="margin-left: 7%">
                ...
                <br/>
                <el-time-select
                    v-model="addChargeList.billingRuleDetailList[0].nightBeginTime"
                    size="small"
                    style="width: 115px;"
                    :picker-options="{
                      start: '06:00',
        ...
        <el-row style="width: 100%;height:50px;margin-top:1%;display:flex">
          ...
          <div style="width: 60%;height:50px;display:flex">
            ...
            <div style="width: 50%;height:50px">
              <el-input
                  v-model="addChargeList.billingRuleDetailList[0].nightBillingPrice"
                  size="small"
                  style="width: 115px"
              ></el-input
              >
        ...
        <el-row style="width: 100%;height:50px;display:flex">
          ...
          <div style="width: 60%;height:50px;display:flex">
            ...
            <div style="width: 50%;height:50px">
              <el-input
                  v-model="addChargeList.billingRuleDetailList[1].nightBillingPrice"
                  size="small"
                  style="width: 115px"
              ></el-input
              >
      ...
      <el-row v-if="addChargeList.billingRuleTypeCode === 1">
        ...
        <el-form>
          <el-form-item label="最短计费时长:" label-width="150px">
            <el-select
                style="width: 200px;"
                v-model="addChargeList.billingRuleDetailList[0].minBillingDurationCode"
            >
              <el-option
        ...
        <el-row style="display: flex">
          ...
          <div style="width: 12%">
            <el-checkbox v-model="addChargeList.billingRuleDetailList[0].ceilingFlag===1"
        ...
        <el-row style="width: 100%;height:50px;margin-top:1%;display:flex">
          ...
          <div style="width: 12%;height:50px">
            <el-input
                v-model="addChargeList.billingRuleDetailList[0].ceilingMoneyAmount"
                size="small"
                style="width: 80px"
            ></el-input
            >
        ...
        <el-row style="width: 100%;height:50px;display:flex">
          ...
          <div style="width: 12%;height:50px">
            <el-input
                v-model="addChargeList.billingRuleDetailList[1].ceilingMoneyAmount"
                size="small"
                style="width: 80px"
            ></el-input
            >
    ...
    >
      ...
      <el-row v-if="checkChargeList.billingRuleTypeCode === 0">
          ...
          <div style="width: 60%">
            ...
            <div style="display: flex">
              <div>
                ...
                <br/>
                <el-time-select
                    v-model="checkChargeList.billingRuleDetailList[0].dayBeginTime"
                    disabled
                    size="small"
                    style="width: 115px;"
                    :picker-options="{
              ...
              <div style="margin-left: 7%">
                ...
                <br/>
                <el-time-select
                    v-model="checkChargeList.billingRuleDetailList[0].nightBeginTime"
                    disabled
                    size="small"
                    style="width: 115px;"
                    :picker-options="{
                ...
                <span>~</span>
                <el-time-select
                    v-model="checkChargeList.billingRuleDetailList[0].nightEndTime"
                    disabled
                    size="small"
                    style="width: 115px;"
                    :picker-options="{
        ...
        <el-row style="width: 100%;height:50px;margin-top:1%;display:flex">
          ...
          <div style="width: 60%;height:50px;display:flex">
            <div style="width: 50%;height:50px">
              <el-input
                  v-model="checkChargeList.billingRuleDetailList[0].dayBillingPrice"
                  disabled
                  size="small"
                  style="width: 115px"
              ></el-input
          ...
          <div style="width: 12%;height:50px">
            <el-input
                v-model="checkChargeList.billingRuleDetailList[0].rebillingDuration"
                disabled
                size="small"
                style="width: 80px"
            ></el-input
        ...
        <el-row style="width: 100%;height:50px;display:flex">
          ...
          <div style="width: 60%;height:50px;display:flex">
            <div style="width: 50%;height:50px">
              <el-input
                  v-model="checkChargeList.billingRuleDetailList[1].dayBillingPrice"
                  disabled
                  size="small"
                  style="width: 115px"
              ></el-input
          ...
          <div style="width: 12%;height:50px">
            <el-input
                v-model="checkChargeList.billingRuleDetailList[1].rebillingDuration"
                disabled
                size="small"
                style="width: 80px"
            ></el-input
      ...
      <el-row v-if="checkChargeList.billingRuleTypeCode === 1">
        ...
        <el-form>
          <el-form-item label="最短计费时长:" label-width="150px">
            <el-select
                v-model="checkChargeList.billingRuleDetailList[0].minBillingDurationCode"
                disabled
            >
              <el-option
                  v-for="(item, index) in minTimeList"
        ...
        <el-row style="display: flex">
          ...
          <div style="width: 12%">
            <el-checkbox
                v-model="checkChargeList.billingRuleDetailList[0].ceilingFlag ===1"
                disabled
            >24小时是否封顶
            </el-checkbox
            >
        ...
        <el-row style="width: 100%;height:50px;margin-top:1%;display:flex">
          ...
          <div style="width: 60%;height:50px;display:flex">
            <div style="width: 50%;height:50px">
              ...
              ></el-input
              >
              元/{{ checkChargeList.billingRuleDetailList[0].minBillingDurationName }}
            </div>
            <div style="width: 50%;height:50px">
              <el-input
                  v-model="checkChargeList.billingRuleDetailList[0].nightBillingPrice"
                  disabled
                  size="small"
                  style="width: 115px"
              ></el-input
          ...
          <div style="width: 12%;height:50px">
            <el-input
                v-model="checkChargeList.billingRuleDetailList[0].ceilingMoneyAmount"
                disabled
                size="small"
                style="width: 80px"
            ></el-input
        ...
        <el-row style="width: 100%;height:50px;display:flex">
          ...
          <div style="width: 60%;height:50px;display:flex">
            ...
            <div style="width: 50%;height:50px">
              <el-input
                  v-model="checkChargeList.billingRuleDetailList[1].nightBillingPrice"
                  disabled
                  size="small"
                  style="width: 115px"
              ></el-input
          ...
          <div style="width: 12%;height:50px">
            <el-input
                v-model="checkChargeList.billingRuleDetailList[1].ceilingMoneyAmount"
                disabled
                size="small"
                style="width: 80px"
            ></el-input
    ...
    >
      ...
      <el-row v-if="alertChargeList.billingRuleTypeCode === 0">
        <span>按次计费</span>
        <el-row style="display: flex">
          <div style="width: 16%">
            <div>车辆类型</div>
          ...
          <div style="width: 60%">
            ...
            <div style="display: flex">
              <div>
                ...
                <br/>
                <el-time-select
                    v-model="alertChargeList.billingRuleDetailList[0].dayBeginTime"
                    size="small"
                    style="width: 100px;"
                    placeholder="选择时间"
                    :picker-options="{
              ...
              <div style="margin-left: 7%">
                ...
                <br/>
                <el-time-select
                    v-model="alertChargeList.billingRuleDetailList[0].nightBeginTime"
                    :picker-options="{
                      start: '06:00',
                      step: '00:30',
                      end: '23:00'
                ...
                <span>~</span>
                <el-time-select
                    v-model="alertChargeList.billingRuleDetailList[0].nightEndTime"
                    :picker-options="{
                      start: '06:00',
                      step: '00:30',
                      end: '23:00'
        ...
        <el-row style="width: 100%;height:50px;margin-top:1%;display:flex">
          ...
          <div style="width: 60%;height:50px;display:flex">
            <div style="width: 50%;height:50px">
              <el-input
                  v-model="alertChargeList.billingRuleDetailList[0].dayBillingPrice"
          ...
          <div style="width: 12%;height:50px">
            <el-input
                v-model="alertChargeList.billingRuleDetailList[0].rebillingDuration"
                size="small"
                style="width: 80px"
            ></el-input
            >
        ...
        <el-row style="width: 100%;height:50px;display:flex">
          ...
          <div style="width: 60%;height:50px;display:flex">
            <div style="width: 50%;height:50px">
              <el-input
                  v-model="alertChargeList.billingRuleDetailList[1].dayBillingPrice"
          ...
          <div style="width: 12%;height:50px">
            <el-input
                v-model="alertChargeList.billingRuleDetailList[1].rebillingDuration"
      ...
      <!-- 按时计费弹出表格 -->
      <el-row v-if="alertChargeList.billingRuleTypeCode === 1">
        <span>按照时长计费</span>
        <el-form>
          <el-form-item label="最短计费时长:" label-width="150px">
            <el-select v-model="alertChargeList.billingRuleDetailList[0].minBillingDurationCode">
              <el-option
                  v-for="(item, index) in minTimeList"
                  :label="item.name"
                  :value="item.code"
        ...
        <el-row style="display: flex">
          ...
          <div style="width: 12%">
            <el-checkbox
                v-model="alertChargeList.billingRuleDetailList[0].ceilingFlag ===1"
        ...
        <el-row style="width: 100%;height:50px;margin-top:1%;display:flex">
          ...
          <div style="width: 60%;height:50px;display:flex">
            ...
            <div style="width: 50%;height:50px">
              <el-input
                  v-model="alertChargeList.billingRuleDetailList[0].nightBillingPrice"
                  size="small"
                  style="width: 115px"
              ></el-input
              >
          ...
          <div style="width: 12%;height:50px">
            <el-input
                v-model="alertChargeList.billingRuleDetailList[0].ceilingMoneyAmount"
                size="small"
                style="width: 80px"
            ></el-input
            >
        ...
        <el-row style="width: 100%;height:50px;display:flex">
          ...
          <div style="width: 60%;height:50px;display:flex">
            ...
            <div style="width: 50%;height:50px">
              <el-input
                  v-model="alertChargeList.billingRuleDetailList[1].nightBillingPrice"
                  size="small"
                  style="width: 115px"
              ></el-input
              >
          ...
          <div style="width: 12%;height:50px">
            <el-input
                v-model="alertChargeList.billingRuleDetailList[1].ceilingMoneyAmount"
                size="small"
                style="width: 80px"
            ></el-input
            >
...
export default {
  ...
  computed: {
    addMinBillingDurationName: function () {
      ...
      this.minTimeList.forEach(item => {
        if (item.code === this.addChargeList.billingRuleDetailList[0].minBillingDurationCode) {
          s = item.name;
        }
      })
      return s;
    ...
    alertMinBillingDurationName: function () {
      let s;
      this.minTimeList.forEach(item => {
        if (item.code === this.alertChargeList.billingRuleDetailList[0].minBillingDurationCode) {
          s = item.name;
        }
      })
      return s;
  ...
  methods: {
    handleAlterClick() {
      if (this.alertChargeList.billingRuleDetailList[0].ceilingFlag === 1) {
        this.alertChargeList.billingRuleDetailList[1].ceilingFlag = 0;
        this.alertChargeList.billingRuleDetailList[0].ceilingFlag = 0;
      } else {
        this.alertChargeList.billingRuleDetailList[1].ceilingFlag = 1;
        this.alertChargeList.billingRuleDetailList[0].ceilingFlag = 1;
      }
    },
    handleAddClick() {
      if (this.addChargeList.billingRuleDetailList[0].ceilingFlag === 1) {
        this.addChargeList.billingRuleDetailList[1].ceilingFlag = 0;
        this.addChargeList.billingRuleDetailList[0].ceilingFlag = 0;
      } else {
        this.addChargeList.billingRuleDetailList[1].ceilingFlag = 1;
        this.addChargeList.billingRuleDetailList[0].ceilingFlag = 1;
      }
    },
    //查询重置按钮
    resetQuery() {
    ...
    queryMinTime() {
      ...
      this.$homePage.queryDict(param).then(response => {
        this.minTimeList = response.resultEntity;
      });
    },
    //计费规则类型按次还是按时
    queryChargeType() {
      ...
      this.$homePage.queryDict(param).then(response => {
        this.chargeTypeList = response.resultEntity;
      });
    },
    //顶部查询按钮获取参数
    ...
    onCommitAdd() {
      this.$refs["addChargeList"].validate(valid => {
        if (valid) {
          this.addChargeList.billingRuleDetailList[1].dayBeginTime = this.addChargeList.billingRuleDetailList[0].dayBeginTime;
          this.addChargeList.billingRuleDetailList[1].dayEndTime = this.addChargeList.billingRuleDetailList[0].dayEndTime;
          this.addChargeList.billingRuleDetailList[1].nightBeginTime = this.addChargeList.billingRuleDetailList[0].nightBeginTime;
          this.addChargeList.billingRuleDetailList[1].nightEndTime = this.addChargeList.billingRuleDetailList[0].nightEndTime;
          this.addChargeList.billingRuleDetailList[1].minBillingDurationCode = this.addChargeList.billingRuleDetailList[0].minBillingDurationCode;
    ...
    handleAlter(row) {
      ...
      this.alertChargeList = row;
    },
    //修改确认提交按钮
    onCommitAlter() {
      this.alterChargeListDialog = false;
      this.alertChargeList.billingRuleDetailList[1].dayBeginTime = this.alertChargeList.billingRuleDetailList[0].dayBeginTime;
      this.alertChargeList.billingRuleDetailList[1].dayEndTime = this.alertChargeList.billingRuleDetailList[0].dayEndTime;
      this.alertChargeList.billingRuleDetailList[1].nightBeginTime = this.alertChargeList.billingRuleDetailList[0].nightBeginTime;
