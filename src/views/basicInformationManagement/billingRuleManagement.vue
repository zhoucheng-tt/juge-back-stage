 ...
 * @LastEditTime: 2020-10-20 10:28:00
...
<template xmlns:el-col="http://www.w3.org/1999/html">
  <div class="all">
      ...
      <el-row>
        <el-form :inline="true" :model="upQueryList" class="demo-form-inline">
          ...
          <el-form-item>
            ...
            <el-button type="primary" @click="deleteChargeMode()">批量删除</el-button>
          </el-form-item>
        </el-form>
      </el-row>
          ...
          <el-col offset="1">
            <el-form-item label="计费规则类型">
              <el-select v-model="upQueryList.chargeMode" placeholder="请选择计费类型">
                <el-option v-for="(item, index) in chargeModeList" :label="item.chargeMode"
                           :value="item.chargeMode" :key="index"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col offset="1">
    ...
    <!--下半部分列表-->
    <div class="down">
      <el-table :data="chargeModeManagement" :row-class-name="tableRowClassName" ref="selectChargeModeManagement"
        ...
        <el-table-column prop="chargeModeNumber" label="计费规则编号" width="100"></el-table-column>
        <el-table-column prop="chargeModeName" :show-overflow-tooltip="true" label="计费规则名称" width="">
        </el-table-column>
        <el-table-column prop="chargeModeType" :show-overflow-tooltip="true" label="计费规则类型" width="">
        </el-table-column>
    ...
    <el-dialog title="计费规则详情" :visible.sync="showListdialogueandoff">
      <el-form :inline="true" :model="showListdialogueandoffList" class="demo-form-inline">
        <el-form-item label="计费规则编号:" class="el-form-item-dialog">
          <el-input v-model="showListdialogueandoffList.chargeModeNumber"></el-input>
        </el-form-item>
        <el-form-item label="计费规则名称:" class="el-form-item-dialog">
          <el-input v-model="showListdialogueandoffList.chargeModeName"></el-input>
        </el-form-item>
        <el-form-item label="计费规则类型:" class="el-form-item-dialog">
          <el-input v-model="showListdialogueandoffList.chargeModeType"></el-input>
        </el-form-item>
    ...
    <el-dialog title="修改计费规则" :visible.sync="editListDialogueandoff">
      <el-form :inline="true" :model="editListDialogueandoffList" class="demo-form-inline">
        <el-form-item label="计费规则编号:" class="el-form-item-dialog">
          <el-input v-model="editListDialogueandoffList.chargeModeNumber"></el-input>
        </el-form-item>
        <el-form-item label="计费规则名称:" class="el-form-item-dialog">
          <el-input v-model="editListDialogueandoffList.chargeModeName"></el-input>
        </el-form-item>
        <el-form-item label="计费规则类型:" class="el-form-item-dialog">
          <el-input v-model="editListDialogueandoffList.chargeModeType"></el-input>
        </el-form-item>
        <el-form-item label="描述:" class="el-form-item-dialog">
...
export default {
  ...
  methods: {
    //批量删除
    deleteChargeMode() {
      console.log("selectChargeModeManagement", this.selectChargeModeManagement)
    },
    //确定方法
    addInfoInsert() {
