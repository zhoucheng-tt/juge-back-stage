            ...
            <div style="display: flex">
              <div>
                ...
                <el-time-select
                  ...
                  size="small"
                  style="width: 115px;"
                  :picker-options="{step: '00:15', start: '00:00',end: '12:00'}"
                  placeholder="选择时间">
                </el-time-select>
                <span>~</span>
                <el-time-select
              ...
              <div style="margin-left: 7%">
                ...
                <el-time-select
                  ...
                  size="small"
                  style="width: 115px;"
                  :picker-options="{step: '00:15', start: '12:00',end: '24:00'}"
                  placeholder="选择时间">
                </el-time-select>
                <span>~</span>
                <el-time-select
        ...
        <el-row style="width: 100%;height:50px;margin-top:1%;display:flex">
          ...
          <div style="width: 60%;height:50px;display:flex">
            <div style="width: 50%;height:50px">
              <el-input v-model="billingRuleDetailList.smalldayBillingPrice" size="small" style="width: 115px"></el-input>元/次
            </div>
            <div style="width: 50%;height:50px">
              <el-input v-model="billingRuleDetailList.smallnightBillingPrice" size="small" style="width: 115px"></el-input>元/次
            </div>
          </div>
          <div style="width: 12%;height:50px">
            <el-input v-model="billingRuleDetailList.smallfreeDuration" size="small" style="width: 80px"></el-input>分钟
          </div>
          <div style="width: 12%;height:50px">
            <el-input v-model="billingRuleDetailList.smallrebillingDuration" size="small" style="width: 80px"></el-input>分钟
          </div>
        </el-row>
<!--    大型车辆计费规则-->
        <el-row  style="width: 100%;height:50px;display:flex">
          ...
          <div style="width: 60%;height:50px;display:flex">
            <div style="width: 50%;height:50px">
              <el-input v-model="billingRuleDetailList.maxdayBillingPrice" size="small" style="width: 115px"></el-input>元/次
            </div>
            <div style="width: 50%;height:50px">
              <el-input v-model="billingRuleDetailList.maxnightBillingPrice" size="small" style="width: 115px"></el-input>元/次
            </div>
          </div>
          <div style="width: 12%;height:50px">
            <el-input v-model="billingRuleDetailList.maxfreeDuration" size="small" style="width: 80px"></el-input>分钟
          </div>
          <div style="width: 12%;height:50px">
            <el-input v-model="billingRuleDetailList.maxrebillingDuration" size="small" style="width: 80px"></el-input>分钟
          </div>
        </el-row>
      </el-row>
      <!-- 按时计费弹出表格 -->
      <el-row v-if="addChargeList.billingRuleTypeCode == 1">
        ...
        <el-form>
          <el-form-item label="最短计费时长:">
            <el-select v-model="billingRuleDetailList.minBillingDurationCode">
              <el-option v-for="(item, index) in minTimeList" :label="item.name"
                         :value="item.code" :key="index"></el-option>
            </el-select>
          </el-form-item>
        </el-form>
        <el-row style="display: flex">
          ...
          <div style="width: 12%">
            <el-radio v-model="billingRuleDetailList.ceilingFlag" label="0">24小时是否封顶</el-radio>
          </div>
        </el-row>
        <!--    获取的小型车辆数据-->
        <el-row style="width: 100%;height:50px;margin-top:1%;display:flex">
          ...
          <div style="width: 60%;height:50px;display:flex">
            <div style="width: 50%;height:50px">
              <el-input v-model="billingRuleDetailList.smalldayBillingPrice" size="small" style="width: 115px"></el-input>元/15分钟
            </div>
            <div style="width: 50%;height:50px">
              <el-input v-model="billingRuleDetailList.smallnightBillingPrice" size="small" style="width: 115px"></el-input>元/15分钟
            </div>
          </div>
          <div style="width: 12%;height:50px">
            <el-input v-model="billingRuleDetailList.smallfreeDuration" size="small" style="width: 80px"></el-input>分钟
          ...
          <div style="width: 12%;height:50px">
            <el-input v-model="billingRuleDetailList.smallceilingMoneyAmount" size="small" style="width: 80px"></el-input>元
          </div>
        </el-row>
        <!--    大型车辆计费规则-->
        <el-row  style="width: 100%;height:50px;display:flex">
          ...
          <div style="width: 60%;height:50px;display:flex">
            <div style="width: 50%;height:50px">
              <el-input v-model="billingRuleDetailList.maxdayBillingPrice" size="small" style="width: 115px"></el-input>元/15分钟
            </div>
            <div style="width: 50%;height:50px">
              <el-input v-model="billingRuleDetailList.maxnightBillingPrice" size="small" style="width: 115px"></el-input>元/15分钟
            </div>
          </div>
          <div style="width: 12%;height:50px">
            <el-input v-model="billingRuleDetailList.maxfreeDuration" size="small" style="width: 80px"></el-input>分钟
          ...
          <div style="width: 12%;height:50px">
            <el-input v-model="billingRuleDetailList.maxceilingMoneyAmount" size="small" style="width: 80px"></el-input>元
          </div>
        </el-row>
      </el-row>
    ...
    <!--查看计费弹窗-->
    <el-dialog title="查看计费信息" :visible.sync="checkChargeListDialog" top="10vh">
...
<!--        </el-form-item>-->
        <span>计费规则信息</span>
        <el-form-item label="计费规则类型:">
          <el-select v-model="checkChargeList.billingRuleTypeCode" placeholder="请选择计费规则">
            <el-option v-for="(item, index) in chargeTypeList" :label="item.name"
                       :value="item.code" :key="index"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="计费规则名称:">
          <el-input v-model="checkChargeList.billingRuleDefName" placeholder="请输入" style="width:225px"></el-input>
        </el-form-item>
        <el-form-item label="计费规则描述:">
          <el-input v-model="checkChargeList.remark" placeholder="请输入" style="width:225px"></el-input>
        </el-form-item>
      </el-form>
      <!-- 按次计费弹出表格 -->
    ...
    <!--修改计费弹窗-->
    <el-dialog title="修改计费信息" :visible.sync="alterChargeListDialog" top="10vh">
      <el-form :model="checkChargeList" label-width="150px">
<!--        <span>停车场信息</span>-->
<!--        <el-form-item label="归属停车场:">-->
<!--          <el-select v-model="checkChargeList.parkId" placeholder="请选择停车场">-->
    ...
    methods: {
      ...
      //新增计费规则提交
        onCommitAdd(){
                ...
                billingRuleDetailList:[
                    {
                        ...
                        ceilingMoneyAmount:this.billingRuleDetailList.smallceilingMoneyAmount,
                        minBillingDurationCode:this.billingRuleDetailList.minBillingDurationCode
                    },
                    {
                        // 大型车辆
                        vehicleTypeCode:'2',
            ...
            this.$basicInformationManagement.insertBillingRule(param).then(response => {
                //添加成功弹出
      ...
      //表中的查看
        handleCheck(row){
            ...
            this.billingRuleDetailList.smallfreeDuration=row.billingRuleDetailList[0].freeDuration;
            this.billingRuleDetailList.smallrebillingDuration=row.billingRuleDetailList[0].rebillingDuration;
            this.billingRuleDetailList.dayBeginTime=row.billingRuleDetailList[0].dayBeginTime;
            this.billingRuleDetailList.dayEndTime=row.billingRuleDetailList[0].dayEndTime;
            this.billingRuleDetailList.nightBeginTime=row.billingRuleDetailList[0].nightBeginTime;
            this.billingRuleDetailList.nightEndTime=row.billingRuleDetailList[0].nightEndTime;
            this.billingRuleDetailList.smalldayBillingPrice=row.billingRuleDetailList[0].dayBillingPrice;
            this.billingRuleDetailList.smallnightBillingPrice=row.billingRuleDetailList[0].nightBillingPrice;
            this.billingRuleDetailList.ceilingFlag=row.billingRuleDetailList[0].ceilingFlag,
            this.billingRuleDetailList.smallceilingMoneyAmount=row.billingRuleDetailList[0].ceilingMoneyAmount;
            this.billingRuleDetailList.minBillingDurationCode=row.billingRuleDetailList[0].minBillingDurationCode;
            this.billingRuleDetailList.maxfreeDuration=row.billingRuleDetailList[1].freeDuration;
            this.billingRuleDetailList.maxrebillingDuration=row.billingRuleDetailList[1].rebillingDuration;
            this.billingRuleDetailList.dayBeginTime=row.billingRuleDetailList[1].dayBeginTime;
            this.billingRuleDetailList.dayEndTime=row.billingRuleDetailList[1].dayEndTime;
            this.billingRuleDetailList.nightBeginTime=row.billingRuleDetailList[1].nightBeginTime;
            this.billingRuleDetailList.nightEndTime=row.billingRuleDetailList[1].nightEndTime;
            this.billingRuleDetailList.maxdayBillingPrice=row.billingRuleDetailList[1].dayBillingPrice;
            this.billingRuleDetailList.maxnightBillingPrice=row.billingRuleDetailList[1].nightBillingPrice;
            this.billingRuleDetailList.ceilingFlag=row.billingRuleDetailList[1].ceilingFlag,
            this.billingRuleDetailList.maxceilingMoneyAmount=row.billingRuleDetailList[1].ceilingMoneyAmount;
            this.billingRuleDetailList.minBillingDurationCode=row.billingRuleDetailList[1].minBillingDurationCode;
        },
      //点击修改按钮
        handleAlter(row){
