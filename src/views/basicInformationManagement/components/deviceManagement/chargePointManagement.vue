    ...
    <div class="up">
      ...
      <el-row class="line-2">
        <el-button type="primary" size="small" @click="addChargingPoint()"
          >新增充电桩</el-button
        >
        <el-button type="primary" size="small" @click="importBatchDia = true"
          >批量导入</el-button
        >
...
export default {
  data() {
    return {
      ...
      //模板下载
      templateDl: BASE_API + "FileController/dlTemplate/充电桩管理",
      //导出
      exportFile: BASE_API + "chargePlieFunc/download",
      fileList: [],
      //新增约束字段
      addListRules: {
        chargPileId: [
  ...
  methods: {
    ...
    myUpload(content) {
      ...
      // 1.导入
      var FileController = "";
      FileController = BASE_API + "chargePlieFunc/upload"; //请求接口
