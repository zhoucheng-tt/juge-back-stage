 ...
 * @LastEditTime: 2020-11-02 19:12:47
          ...
          <el-col :span="12">
            <el-form-item label="停车场类型名称:" label-width="150px">
              <el-select v-model="newParkingLot.parkTypeName" placeholder="请选择">
                <el-option v-for="(item, index) in parkingLotType" :label="item.name" :value="item.name" :key="index">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="归属企业名称:" label-width="150px">
              <el-select v-model="newParkingLot.companyName" placeholder="请选择">
                <el-option v-for="(item, index) in enterprises" :label="item.name" :value="item.name" :key="index">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="归属地市:" label-width="150px">
              <el-select v-model="newParkingLot.cityName" placeholder="请选择">
                <el-option v-for="(item, index) in cityList" :label="item.name" :value="item.name" :key="index">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="归属区县:" label-width="150px">
              <el-select v-model="newParkingLot.districtName" placeholder="请选择">
                <el-option v-for="(item, index) in districtList" :label="item.name" :value="item.name" :key="index">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
