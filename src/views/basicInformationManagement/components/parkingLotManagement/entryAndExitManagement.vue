 ...
 * @LastEditTime: 2020-10-30 13:57:15
  ...
  <div class="all">
          ...
          <el-form :inline="true" :model="addListDialogueandoffList" class="demo-form-inline">
            ...
            <el-col offset="1">
              ...
              <el-form-item label="出入口名称:">
                <el-input v-model="addListDialogueandoffList.entryAndExitName" placeholder="请输入出入口名称"
                  style="width: 300px"></el-input>
              </el-form-item>
            </el-col>
            <el-col offset="1">
              <el-form-item label="出入口类型:">
                <el-select v-model="addListDialogueandoffList.entryAndExitType" placeholder="请选择出入口类型"
                  style="width: 300px">
    ...
    <div class="down">
      <el-table :data="manageEntryAndExit" :row-class-name="tableRowClassName" ref="selectManageEntryAndExit"
        ...
        <el-table-column prop="parkId" label="停车场编号" width="100"></el-table-column>
        ...
        <el-table-column prop="passagewayId" :show-overflow-tooltip="true" label="出入口编号"></el-table-column>
      ...
      <el-dialog title="修改出入口管理" :visible.sync="editListDialogueandoff">
        <el-form :inline="true" :model="editListDialogueandoffList" class="demo-form-inline">
          ...
          <el-form-item label="出入口名称:" class="el-form-item-dialog">
            <el-input v-model="editListDialogueandoffList.passagewayId"></el-input>
          </el-form-item>
