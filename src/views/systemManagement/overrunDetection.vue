  ...
  <div class="about">
    ...
    <div class="table">
      ...
      >
        <!--基本信息-->
        <div class="table-add">
          <el-form :inline="true" class="demo-form-inline" label-position=right label-width="100px" :model="addRoleList" ref="addRoleListR" :rules="addListRules">
            ...
            <el-row style="padding-top: 20px">
              <el-col :span="12">
                <el-form-item label="角色名称:" label-width="150px">
                  <el-input v-model="viewList.roleName" readonly></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="角色描述:" label-width="150px">
                  <el-input v-model="viewList.roleDesc" readonly></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
