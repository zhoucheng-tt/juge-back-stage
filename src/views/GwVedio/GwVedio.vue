 ...
 * @LastEditTime: 2020-10-17 16:08:48
...
<template>
	<div class="home">
		...
		<div style="background-color:rgb(3, 18, 41); overflow: hidden; height: 100%">
			<el-row class="header">
				<el-col :span="6">
					...
					<el-row style="height: 24%;padding-bottom:15px">
						...
						<el-row style="height: 75%; ">
							...
							<div class="pie-statistics">
								...
								<span style="padding:0px 10px; color: rgb(0,122,255);position: relative;top: -16px;left: 122%">62%</span>
								<li style="color:rgb(3,215,233)">
									<span style="color:white">省外</span>
								</li>
								<span style="padding:0 10px;color:rgb(3,215,233);position: relative;top: -15px;left: 121%;">38%</span>
							</div>
						</el-row>
					</el-row>
					...
					<el-row style="height: 24%;padding-bottom:15px">
						...
						<el-row style="height: 75%; ">
							...
							<div class="pie-statistics">
								...
								<span style="padding:0px 10px; color: rgb(0,122,255);
              position: relative;top: -16px;left: 122%">72%</span>
								<li style="color:rgb(156,64,255)">
									<span style="color:white">货车</span>
								</li>
								<span style="padding:0 10px;color:rgb(3,215,233);position: relative;
              top: -15px;left: 121%;">28%</span>
							</div>
						</el-row>
					</el-row>
						...
						<div style="height:97%;border: 1px solid #66e3fb;margin:11px">
							...
							<el-row style="padding:29px 0 0 49px;text-align: left;">
								...
								<div class="index-show-tcsc">
									...
									<div style="">
										<span class="mid-per-red" style="color:rgb(126,0,252)">60</span>
							...
							<el-row style="padding:29px 0 0 49px;text-align: left;">
								<el-col :span="4" style="margin-top:400px">
									<div style="position:relative;left:3%">
										<el-row style="margin:5px 0">
											<span class="marking-border" style="background:red;color:red;border: 1px solid #79f4fc;">marking</span>
											<span class="mid-marking">已占用</span>
										</el-row>
										<el-row style="margin:5px 0 5px 0">
											<span class="marking-border" style="background:#009245;color:#009245;border: 1px solid #79f4fc;">marking</span>
					...
					<el-row style="height: 33%; ">
						...
						<el-row style="height: 75%; ">
							...
							<el-row class="table-data">
								...
								<el-col :span="8" class="table-line" style="color: #05C700;">{{shengNum}}</el-col>
							</el-row>
							<el-row class="table-data">
...
<script>
  ...
  import { queryImgUrl, queryList } from '@/axios/ysParking/ysParking'
			...
			queryImgUrl() {
				...
				queryImgUrl()
					.then(response => {
						...
						that.imgUrl = 'http://paks.jitunet.cn:83/parkingspace/parking/record/imgInfo.action?name=' + response.data.fileAddr;
