<template>
	<el-container class="header-style">
		...
		<div class="header-setting menu-box">
			...
			<div style="width: 100%;height: 50%;color: #FFF;">
				<span style="position: relative;left: 1px;color: #FFF;">{{weatherList.type}}</span>
				<span
					style="position: relative;right: 1px;float: right;color: #FFF;">{{weatherList.low}}/{{weatherList.high}}</span>
			</div>
		</div>
		<div class="header-setting menu-box" style="right: 100px;font-size: 15px;">
			<div style="width: 100%;height: 60%;color: #FFF;">
				{{userName}}
				<span style="position: relative;right: 1px;float: right;color: #CCC;cursor:pointer;"
